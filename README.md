...
- [eda.ipynb](https://github.com/wuisabel-gif/biological-response-modeling): exploratory analysis of the raw features and target behavior
- [pytorch.ipynb](https://github.com/wuisabel-gif/biological-response-modeling): early PyTorch baseline experiments
- [pytorch_iteration_2.ipynb](https://github.com/wuisabel-gif/biological-response-modeling): updated PyTorch iteration
- [pytorch_training_final.ipynb](https://github.com/wuisabel-gif/biological-response-modeling): later-stage training workflow
- [pytorch_inference_final.ipynb](https://github.com/wuisabel-gif/biological-response-modeling): later-stage inference workflow
- [pytorch_best_score_0_01839.ipynb](https://github.com/wuisabel-gif/biological-response-modeling): stronger PyTorch result snapshot
- [tabnet_experiments.ipynb](https://github.com/wuisabel-gif/biological-response-modeling): TabNet modeling experiments
- [ensemble.ipynb](https://github.com/wuisabel-gif/biological-response-modeling): blending and ensemble logic
- [submission_correlation_analysis.ipynb](https://github.com/wuisabel-gif/biological-response-modeling): submission-correlation analysis
...
To recreate the environment, install the packages listed in [requirements.txt](https://github.com/wuisabel-gif/biological-response-modeling).
